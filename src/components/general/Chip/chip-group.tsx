...
const ChipGroup: React.FC<Props> = (props : Props) => {
  ...
  const customString : string = (props.customString) ? props.customString : "Value"
    ...
    <div>
      {
        labels.map((current : string, index : number) =>
          <Chip key={uid + "_" + index} id={uid + "_" + index} label={current} setterFunction={setterFunction} isSelected={current === selected}/>
        )
      }
      {
        (allowCustom)
          ? <>
              {
                (customChipLabel !== "")
                ? <Chip key={uid + "_custom"} id={uid + "_custom"} label={customChipLabel} setterFunction={setterFunction} isSelected={customChipLabel === selected} isCustom/>
                : <></>
              }
              <Chip key={uid + "_add"} id={uid + "_add"} label={"+"} setterFunction={setterFunction} />
            </>
        : <></>
      }
    </div>
