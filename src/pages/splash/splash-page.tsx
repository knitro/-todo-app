...
import StyledFirebaseAuth from "../../firebase/firebaseui-react/StyledFirebaseAuth";
          ...
          <IonRow>
            <IonCol>
              <StyledFirebaseAuth
                ...
                className="splash-page-background"
              />
            </IonCol>
          </IonRow>
        </IonGrid>

        <div className="splash-page-login-buttons"></div>
      </IonContent>
    </IonPage>
  );
};
